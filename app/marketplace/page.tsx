...
} from "@/public/images/categories/marketplace/produce-public";
...
export default async function MarketplacePage({ searchParams }: Props) {
  ...
  const totalPages = Math.max(1, Math.ceil(listingsRes.count / pageSize));
        ...
        <div className="mb-5 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">
              {listingsRes.count} published listing
              {listingsRes.count === 1 ? "" : "s"} found
            </p>
          </div>
