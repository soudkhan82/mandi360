...
const unitOptions = ["Kg", "Maund", "Ton", "Bag", "Crate", "Dozen"];

export default async function PostProducePage() {
      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Add simple crop details. Admin approval is required before
            publishing.
          </p>
        </div>

        <form
          action="/post-ad/produce/submit"
          method="post"
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="sm:col-span-2">
              ...
              <input
                name="title"
                required
                placeholder="Fresh citrus for sale"
            ...
            <div>
              ...
              <input
                name="variety"
                placeholder="Kinnow, Basmati, etc."
                className="mt-1 w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm text-slate-900 outline-none focus:border-emerald-500"
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                name="description"
                rows={4}
                placeholder="Write short details about quality, location, packing, harvest date, etc."
